...
from ollama_deep_researcher.memory_client import (
    MemoryCapture, 
...
async def _tool_enhanced_research_async(state: SummaryState, config: RunnableConfig):
    ...
    print("...Starting tool-enhanced research...")
...
"""
            ...
            if source.strip():
                ...
                if ':' in source_line and any(protocol in source_line for protocol in ['http://', 'https://', 'www.']):
                    ...
                    if len(parts) == 2:
                        ...
                        # High Reliability Academic Sources
                        if 'arxiv.org' in url:
                            reliability = "High"
                            source_type = "Peer-Reviewed Preprint"
                        elif any(domain in url for domain in [
                            'ieee.org', 'acm.org', 'nature.com', 'science.org', 'sciencedirect.com',
                            'springer.com', 'elsevier.com', 'wiley.com', 'mit.edu', 'stanford.edu',
                            'harvard.edu', 'oxford.ac.uk', 'cambridge.org', 'pnas.org', 'cell.com',
                            'nejm.org', 'bmj.com', 'thelancet.com', 'jstor.org', 'pubmed.ncbi.nlm.nih.gov',
                            'nih.gov', 'nist.gov', 'nasa.gov', 'cern.ch', 'who.int', 'un.org',
                            'berkeley.edu', 'scholar.google.com', 'scholar.google.co.th'
                        ]):
                            reliability = "High" 
                            source_type = "Academic Publication"
                        
                        # High Reliability Government & Official Sources
                        elif any(domain in url for domain in [
                            'gov.uk', 'europa.eu', 'whitehouse.gov', 'congress.gov', 'senate.gov',
                            'fda.gov', 'cdc.gov', 'epa.gov', 'sec.gov', 'treasury.gov', 'fed.gov',
                            'bis.org', 'imf.org', 'worldbank.org', 'oecd.org', 'wto.org'
                        ]):
                            reliability = "High"
                            source_type = "Government Source"
                        
                        # High Reliability Tech Documentation & Standards
                        elif any(domain in url for domain in [
                            'w3.org', 'rfc-editor.org', 'iso.org', 'ietf.org', 'unicode.org',
                            'openai.com/research', 'research.google.com', 'research.microsoft.com',
                            'research.fb.com', 'deepmind.com', 'ai.google', 'openai.com/blog'
                        ]):
                            reliability = "High"
                            source_type = "Technical Standards"
                        
                        # Medium-High Reliability Technical Documentation
                        elif any(domain in url for domain in [
                            'github.com', 'docs.', 'readthedocs.', 'tensorflow.org', 'pytorch.org',
                            'kubernetes.io', 'docker.com', 'python.org', 'nodejs.org', 'mozilla.org',
                            'developer.mozilla.org', 'developers.google.com', 'docs.microsoft.com',
                            'aws.amazon.com', 'cloud.google.com', 'azure.microsoft.com',
                            'stackoverflow.com', 'stackexchange.com', 'w3schools.com',
                            'splunk.com', 'elastic.co', 'phantom.us', 'demisto.com', 'siemplify.co'
                        ]):
                            reliability = "Medium"
                            source_type = "Technical Documentation"
                        
                        # Medium Reliability News & Media
                        elif any(domain in url for domain in [
                            'reuters.com', 'bloomberg.com', 'ap.org', 'bbc.com', 'cnn.com',
                            'nytimes.com', 'wsj.com', 'washingtonpost.com', 'economist.com',
                            'ft.com', 'guardian.co.uk', 'npr.org', 'pbs.org', 'techcrunch.com',
                            'wired.com', 'arstechnica.com', 'theverge.com', 'venturebeat.com',
                            # Thai News Sources
                            'thairath.co.th', 'khaosod.co.th', 'bangkokpost.com', 'nationthailand.com',
                            'matichon.co.th', 'dailynews.co.th', 'posttoday.com', 'manager.co.th',
                            # International News Sources
                            'asahi.com', 'nikkei.com', 'japantimes.co.jp', 'koreatimes.co.kr',
                            'scmp.com', 'straitstimes.com', 'channelnewsasia.com', 'thejakartapost.com',
                            'philstar.com', 'inquirer.net', 'voanews.com', 'dw.com', 'france24.com'
                        ]):
                            reliability = "Medium"
                            source_type = "News Source"
                        
                        # Medium Reliability Educational & Professional
                        elif any(domain in url for domain in [
                            'coursera.org', 'edx.org', 'khanacademy.org', 'udacity.com',
                            'pluralsight.com', 'linkedin.com/learning', 'wikipedia.org',
                            'britannica.com', 'investopedia.com', 'mckinsey.com', 'bcg.com',
                            'deloitte.com', 'pwc.com', 'gartner.com', 'forrester.com'
                        ]):
                            reliability = "Medium"
                            source_type = "Educational Resource"
                        
                        # Medium Reliability Cybersecurity & InfoSec
                        elif any(domain in url for domain in [
                            'bleepingcomputer.com', 'thehackernews.com', 'darkreading.com',
                            'securityaffairs.com', 'krebsonsecurity.com', 'schneier.com',
                            'sans.org', 'owasp.org', 'mitre.org', 'cve.mitre.org', 'nvd.nist.gov',
                            'us-cert.gov', 'cert.org', 'cisa.gov', 'crowdstrike.com/blog',
                            'fireeye.com', 'symantec.com/blogs', 'trendmicro.com/en_us/research',
                            'kaspersky.com/blog', 'malwarebytes.com/blog', 'securelist.com'
                        ]):
                            reliability = "Medium"
                            source_type = "Cybersecurity Source"
                        
                        # Medium Reliability Blogs & Publications
                        elif any(domain in url for domain in [
                            'medium.com', 'substack.com', 'towards.ai', 'towardsdatascience.com',
                            'blog.', 'dev.to', 'hashnode.com', 'hackernoon.com', 'freecodecamp.org'
                        ]):
                            reliability = "Medium"
                            source_type = "Blog Post"
                        
                        # Medium Reliability Industry & Company Sources
                        elif any(domain in url for domain in [
                            'ibm.com', 'intel.com', 'nvidia.com', 'amd.com', 'qualcomm.com',
                            'apple.com', 'microsoft.com', 'google.com', 'amazon.com', 'meta.com',
                            'salesforce.com', 'oracle.com', 'sap.com', 'cisco.com', 'vmware.com'
                        ]):
                            reliability = "Medium"
                            source_type = "Industry Source"
                        
                        # Lower Reliability Social & Forum Sources
                        elif any(domain in url for domain in [
                            'reddit.com', 'quora.com', 'twitter.com', 'facebook.com', 'linkedin.com',
                            'youtube.com', 'instagram.com', 'tiktok.com', 'discord.com', 'telegram.org'
                        ]):
                            reliability = "Low"
    ...
    # Capture research memory (Option A: Minimal Integration)
    configurable = Configuration.from_runnable_config(config)
    if configurable.memory_enabled:
        try:
            print("💾 Capturing research memory...")
            
            # Initialize memory client if not already done
            if not get_memory_client():
                memory_config = MemoryCapture(
                    enabled=configurable.memory_enabled,
                    mcp_server_path=configurable.memory_mcp_server_path or "",  # Auto-detect if empty
                    app_name="local-deep-researcher",
                    capture_level=configurable.memory_capture_level
                )
                initialize_memory_client(memory_config)
            
            # Determine overall source reliability and type based on all sources
            source_reliability_scores = {"High": 0, "Medium": 0, "Low": 0}
            source_types = {}
            
            for source in unique_sources:
                if isinstance(source, str) and any(protocol in source for protocol in ['http://', 'https://', 'www.']):
                    # Extract URL for analysis
                    url = source
                    if ':' in source:
                        url_part = source.split(':', 1)[1].strip()
                        if any(protocol in url_part for protocol in ['http://', 'https://', 'www.']):
                            url = url_part
                    
                    # Apply same domain classification logic as above
                    if 'arxiv.org' in url:
                        source_reliability_scores["High"] += 1
                        ...
                        source_reliability_scores["High"] += 1
                        if any(gov_domain in url for gov_domain in ['gov', 'europa.eu', 'who.int', 'un.org']):
                        ...
                        'splunk.com', 'elastic.co', 'phantom.us', 'demisto.com', 'siemplify.co',
                        'reuters.com', 'bloomberg.com', 'ap.org', 'bbc.com', 'cnn.com', 
                        'nytimes.com', 'wsj.com', 'wikipedia.org', 'thairath.co.th', 'khaosod.co.th',
                        'bangkokpost.com', 'bleepingcomputer.com', 'thehackernews.com', 'darkreading.com',
                        'securityaffairs.com', 'krebsonsecurity.com', 'sans.org', 'owasp.org'
                    ]):
                        source_reliability_scores["Medium"] += 1
                        if any(tech_domain in url for tech_domain in ['github.com', 'docs.', 'readthedocs.', 'stackoverflow.com', 'w3schools.com', 'splunk.com', 'elastic.co']):
                            source_types["Technical"] = source_types.get("Technical", 0) + 1
                        elif any(cyber_domain in url for cyber_domain in ['bleepingcomputer.com', 'thehackernews.com', 'darkreading.com', 'securityaffairs.com', 'krebsonsecurity.com', 'sans.org', 'owasp.org']):
                            source_types["Cybersecurity"] = source_types.get("Cybersecurity", 0) + 1
                        elif any(news_domain in url for news_domain in ['reuters.com', 'bloomberg.com', 'bbc.com', 'thairath.co.th', 'khaosod.co.th', 'bangkokpost.com']):
            ...
            # Determine overall reliability (prioritize highest quality sources)
            overall_reliability = "medium"
            if source_reliability_scores["High"] > 0:
                overall_reliability = "high"
            elif source_reliability_scores["Low"] > source_reliability_scores["Medium"]:
                overall_reliability = "low"
            
            # Determine primary source type
            primary_source_type = "web"
            if source_types:
                primary_source_type = max(source_types.keys(), key=lambda k: source_types[k]).lower()
            
            # Capture the final research report with intelligent classification
            asyncio.run(capture_memory_safe(
                ...
                metadata={
                    ...
                    "reliability_breakdown": source_reliability_scores,
                    "source_type_breakdown": source_types
                }
            ))
            
            print("✅ Research memory captured successfully")
            
        except Exception as e:
            print(f"⚠️ Memory capture failed (non-blocking): {str(e)}")
            # Continue execution even if memory capture fails
